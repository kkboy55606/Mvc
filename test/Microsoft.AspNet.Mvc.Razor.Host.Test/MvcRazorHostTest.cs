...
namespace Microsoft.AspNet.Mvc.Razor
{
    public class MvcRazorHostTest
    {
        ...
        public static IEnumerable<object[]> Parser_NormalizesChunkInheritanceUtilityPaths_Data
        {
            get
            {
        ...
        [Theory]
        [MemberData("Parser_NormalizesChunkInheritanceUtilityPaths_Data")]
        ...
        public static IEnumerable<object[]> Generator_NormalizesChunkInheritanceUtilityPaths_Data
        {
            get
            {
                yield return new object[] { "//" };
        ...
        [Theory]
        [MemberData("Generator_NormalizesChunkInheritanceUtilityPaths_Data")]
