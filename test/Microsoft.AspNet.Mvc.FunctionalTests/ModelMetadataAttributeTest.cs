...
namespace Microsoft.AspNet.Mvc.FunctionalTests
{
    public class ModelMetadataAttributeTest
    {
        ...
        public async Task ModelMetaDataTypeAttribute_InvalidPropertiesAndSubPropertiesOnBaseClass_ReturnsErrors()
        {
            ...
            Assert.Equal(ContentNormalizer.GetNormalizedContent("The Category field is required."), json["Category"]);
            Assert.Equal(ContentNormalizer.GetNormalizedContent("The Contact Us field is required."), json["Contact"]);
            Assert.Equal(
                ContentNormalizer.GetNormalizedContent("The Detail2 field is required."),
                json["ProductDetails.Detail2"]);
            Assert.Equal(
                ContentNormalizer.GetNormalizedContent("The Detail3 field is required."),
        ...
        public async Task ModelMetaDataTypeAttribute_InvalidComplexTypePropertyOnBaseClass_ReturnsErrors()
        {
            ...
            Assert.Equal(
                ContentNormalizer.GetNormalizedContent("The ProductDetails field is required."),
                json["ProductDetails"]);
        }
